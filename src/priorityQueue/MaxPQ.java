...
public class MaxPQ<Key> implements Iterable<Key>
{
	...
	public static void main(String[] args)
	{
		...
		//String[] inputArray = { "P", "Q", "E", "-", "X", "A", "M", "-", "P", "L", "E", "-" };
		Rectangle[] rectangleArray = {new Rectangle(4,2), new Rectangle(6,8), new Rectangle(3,1), new Rectangle(9,7), new Rectangle(1,8), new Rectangle(6,7)};
